...
namespace CargoBot
{
    ...
    public class CargoBotPlugin : TerrariaPlugin
    {
        ...
        public static List<CargoBotLevel> Levels = new List<CargoBotLevel>()
        {
            #region 1

            new CargoBotLevel("Cargo 101", 1,
                new List<int[]>
                {
                    new int[] { y },
                    new int[] { },
            ...
            new CargoBotLevel("Transporter", 1,
                new List<int[]>
                {
                    new int[] { y },
                    new int[] { },
            ...
            new CargoBotLevel("From Beneath", 1,
                new List<int[]>
                {
                    new int[] { y, b, b, b, b },
                    new int[] { },
            ...
            new CargoBotLevel("Double Flip", 1,
                new List<int[]>
                {
                    new int[] { b, r, g, y },
                    new int[] { },
            ...
            new CargoBotLevel("Shuffle Sort", 2,
                new List<int[]>
                {
                    new int[] { },
                    new int[] { b, y, b, y, b, y },
            ...
            new CargoBotLevel("Go the Distance", 1,
                new List<int[]>
                {
                    new int[] { y },
                    new int[] { y },
            ...
            new CargoBotLevel("Color Sort", 2,
                new List<int[]>
                {
                    new int[] { },
                    new int[] { g, g, r, g, r, r },
            ...
            new CargoBotLevel("Walking Piles", 1,
                new List<int[]>
                {
                    new int[] { b, b, b, b },
                    new int[] { b, b, b, b },
            ...
            new CargoBotLevel("Repeat Inverter", 1,
                new List<int[]>
                {
                    new int[] { y, r, g, b },
                    new int[] { },
            ...
            new CargoBotLevel("Double Sort", 2,
                new List<int[]>
                {
                    new int[] { },
                    new int[] { b, b, y, y },
            ...
            new CargoBotLevel("Lay it out", 1,
                new List<int[]>
                {
                    new int[] { g, g, g, g, g, g },
                    new int[] { },
            ...
            new CargoBotLevel("The Stacker", 5,
                new List<int[]>
                {
                    new int[] { },
                    new int[] { y },
            ...
            new CargoBotLevel("Come Together", 1,
                new List<int[]>
                {
                    new int[] { },
                    new int[] { },
            ...
            new CargoBotLevel("Come Together 2", 1,
                new List<int[]>
                {
                    new int[] { },
                    new int[] { y },
            ...
            new CargoBotLevel("Up The Greens", 1,
                new List<int[]>
                {
                    new int[] { g },
                    new int[] { b, b },
            ...
            new CargoBotLevel("Fill The Blanks", 1,
                new List<int[]>
                {
                    new int[] { g, g, g, g },
                    new int[] { r },
            ...
            new CargoBotLevel("Count The Blues", 1,
                new List<int[]>
                {
                    new int[] { y, b, b },
                    new int[] { },
            ...
            new CargoBotLevel("Multi Sort", 1,
                new List<int[]>
                {
                    new int[] { },
                    new int[] { b, y },
            ...
            new CargoBotLevel("Divide by two", 1,
                new List<int[]>
                {
                    new int[] { b, b, b, b },
                    new int[] { },
            ...
            new CargoBotLevel("The Merger", 1,
                new List<int[]>
                {
                    new int[] { b, b, b },
                    new int[] { },
            ...
            new CargoBotLevel("Even the Odds", 1,
                new List<int[]>
                {
                    new int[] { g, g, g, g, g },
                    new int[] { },
            ...
            new CargoBotLevel("Genetic Code", 1,
                new List<int[]>
                {
                    new int[] { g, y, y, g, y, g },
                    new int[] { },
            ...
            new CargoBotLevel("Multi Sort 2", 1,
                new List<int[]>
                {
                    new int[] { },
                    new int[] { b, y, r, g, y },
            ...
            new CargoBotLevel("Restoring Order", 1,
                new List<int[]>
                {
                    new int[] { },
                    new int[] { b, r, b, b },
            ...
            new CargoBotLevel("Changing  Places", 1,
                new List<int[]>
                {
                    new int[] { r },
                    new int[] { r, r, r },
            ...
            new CargoBotLevel("Palette Swap", 2,
                new List<int[]>
                {
                    new int[] { },
                    new int[] { r, b },
            ...
            new CargoBotLevel("Changing Places 2", 1,
                new List<int[]>
                {
                    new int[] { r },
                    new int[] { r, r, r },
            ...
            new CargoBotLevel("Vertical Sort", 2,
                new List<int[]>
                {
                    new int[] { },
                    new int[] { g, b, g, b, b },
            ...
            new CargoBotLevel("Count in Binary", 1,
                new List<int[]>
                {
                    new int[] { g, g, g, g, g, g },
                    new int[] { },
            ...
            new CargoBotLevel("Parting the Sea", 1,
                new List<int[]>
                {
                    new int[] { },
                    new int[] { b, b },
        ...
        public static Dictionary<string, Dictionary<string, CargoBotLevel>> LevelsByName =
            new Dictionary<string, Dictionary<string, CargoBotLevel>>()
            {
                { "Tutorial", new Dictionary<string, CargoBotLevel>()
                    {
                        { "Cargo 101", Levels[0] },
                        { "Transporter", Levels[1] },
                        { "Re-Curses", Levels[2] },
                        { "Inverter", Levels[3] },
                        { "From Beneath", Levels[4] },
                        { "Go Left", Levels[5] },
                    }
                },
                { "Easy", new Dictionary<string, CargoBotLevel>()
                    {
                        { "Double Flip", Levels[6] },
                        { "Go Left 2", Levels[7] },
                        { "Shuffle Sort", Levels[8] },
                        { "Go the Distance", Levels[9] },
                        { "Color Sort", Levels[10] },
                        { "Walking Piles", Levels[11] },
                    }
                },
                { "Medium", new Dictionary<string, CargoBotLevel>()
                    {
                        { "Repeat Inverter", Levels[12] },
                        { "Double Sort", Levels[13] },
                        { "Mirror", Levels[14] },
                        { "Lay it out", Levels[15] },
                        { "The Stacker", Levels[16] },
                        { "Clarity", Levels[17] },
                    }
                },
                { "Hard", new Dictionary<string, CargoBotLevel>()
                    {
                        { "Come Together", Levels[18] },
                        { "Come Together 2", Levels[19] },
                        { "Up The Greens", Levels[20] },
                        { "Fill The Blanks", Levels[21] },
                        { "Count The Blues", Levels[22] },
                        { "Multi Sort", Levels[23] },
                    }
                },
                { "Crazy", new Dictionary<string, CargoBotLevel>()
                    {
                        { "Divide by two", Levels[24] },
                        { "The Merger", Levels[25] },
                        { "Even the Odds", Levels[26] },
                        { "Genetic Code", Levels[27] },
                        { "Multi Sort 2", Levels[28] },
                        { "The Swap", Levels[29] },
                    }
                },
                { "Impossible", new Dictionary<string, CargoBotLevel>()
                    {
                        { "Restoring Order", Levels[30] },
                        { "Changing  Places", Levels[31] },
                        { "Palette Swap", Levels[32] },
                        { "Mirror 2", Levels[33] },
                        { "Changing Places 2", Levels[34] },
                        { "Vertical Sort", Levels[35] },
                    }
                },
                { "Unknown", new Dictionary<string, CargoBotLevel>()
                    {
                        { "Count in Binary", Levels[36] },
                        { "Parting the Sea", Levels[37] },
                        { "The Trick", Levels[38] },
                    }
                }
            };
